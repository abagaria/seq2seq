...
# vanilla dataset. The model will be largely identical to the
# seq2seq model for the BPE-dataset, except that there are two separate
# word embeddings for the encoder (french) and decoder (english).
