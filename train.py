...
def train(input_sentences, output_sentences, input_vocab, output_vocab, input_reverse, output_reverse, hy, writer):
    ...
    for epoch in range(1, hy.num_epochs + 1):
        ...
        torch.save(encoder.state_dict(), "saved_runs_batched/encoder_{}_weights.pt".format(epoch))
        torch.save(decoder.state_dict(), "saved_runs_batched/decoder_{}_weights.pt".format(epoch))
